...
BEGIN
    ...
    -- Fetch the associated ISBN and book name from issued_status
    SELECT 
        issued_book_isbn,
        issued_book_name
    INTO
...
BEGIN
    ...
    IF v_status IS NULL THEN
        SELECT CONCAT('Book with ISBN ', p_issued_book_isbn, ' not found.') AS message;
...
CALL issue_book('ISS001', 'MEM123456', '978-3-16-148410-0', 'EMP001');
